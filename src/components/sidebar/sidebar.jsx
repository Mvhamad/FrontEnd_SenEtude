        ...
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50">
          ...
          <ul className="space-y-2 font-medium">
            ...
            <li>
              ...
              >
                <i className="fa-solid fa-user-graduate text-lg ml-1.5 text-gray-500"></i>
                <span
              ...
              <ul
                id="dropdown-example"
                className={
                  hideDropDownEtud ? "hidden " : " " + "py-2 space-y-2"
                }
              >
            ...
            <li>
              ...
              >
                <i className="fa-solid fa-building-columns text-lg ml-1.5 text-gray-500"></i>
